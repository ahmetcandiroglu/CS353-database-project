    ...
    if(mysqli_num_rows($venueResult) > 0) {
      echo "<thead>
            <tr>
              ...
              <th class='text-center'>Venue Created </th>
              <th class='text-center'>Edit Venue </th>
              <th class='text-center'>Delete Venue </th>
              </tr>
           </thead>
           <tbody>";
    }
    else {
      echo "<h3 class='text-center'><b>You are not currently managing any Venue.</b></h3>";
    }
