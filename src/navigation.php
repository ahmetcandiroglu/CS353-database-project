<nav class="navbar navbar-expand-lg navbar-light bg-primary">
  <a class="navbar-brand" href="explore_people.php" style="color: white;"><b>Social Network</b></a>

  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item" >
        <a style="color: white;" class="nav-link active" href="explore.php">Explore &nbsp;</a>
      </li>
      <li class="nav-item">
