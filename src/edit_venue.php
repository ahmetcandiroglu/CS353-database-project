<?php
  ...
  $sql = "SELECT * FROM venue WHERE venueID = $vid";
  $venueInfo = mysqli_query($db, $sql);
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="vname" id="vname" value="<?php echo htmlspecialchars($venueInfo['venueName']); ?> class="form-control" required>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
